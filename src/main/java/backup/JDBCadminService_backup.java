...
//
//public class JDBCadminService_backup implements adminService{
//
//	 int stuNum;
//	 String stuName;
//	 String stuBirth;
...
//				Applicant applicant = new Applicant(stuNum, stuName, stuBirth, stuDept, stuPhoneNum, 
//						stuAddress, stuDetailAddress,
//						appliType, stuGrade, stuMail, auditScore, stuGender);
...
//		Connection con = dataSource.getConnection();
//		String TempSql = "CREATE TEMPORARY TABLE temp_applicant ("+
//			    "id INT AUTO_INCREMENT PRIMARY KEY,"+
//			    "stuNum INT NOT NULL,"+
//			    "stuName VARCHAR(255),"+
//			    "stuBirth DATE,"+
//			    "stuDept VARCHAR(255),"+
//			    "stuPhoneNum VARCHAR(20),"+
//			    "stuAddress VARCHAR(255),"+
//			    "stuDetailAddress VARCHAR(255),"+
//			    "appliType VARCHAR(50),"+
//			    "stuMail VARCHAR(255),"+
//			    "auditScore DOUBLE,"+
//			    "stuGrade DOUBLE,"+
//			    "stuGender VARCHAR(2)"+
//			")";
//		PreparedStatement st = con.prepareStatement(TempSql);		
//		st.execute();
//
//		String InsertTempSql = "INSERT INTO temp_applicant (stuNum, stuName, stuBirth, stuDept, stuPhoneNum, stuAddress, stuDetailAddress, appliType, stuMail, auditScore, stuGrade, stuGender)"+
//		"SELECT * FROM applicant ORDER BY auditScore DESC, stuNum limit 5";
//
//	
//		st = con.prepareStatement(InsertTempSql);		
//		st.executeUpdate();
//		
//		String DelDuplieScoreSql = "delete from temp_applicant where auditScore = ?";
//		st = con.prepareStatement(DelDuplieScoreSql);
//		st.setDouble(1,dupliScore);
//		int rowCount = st.executeUpdate();
//		
//		for(int i=0; i<rowCount; i++) {
//			DuplicateEntity duplicate = DuplicateList.get(i);
//			String InsertChosenMemSql = "insert into temp_applicant(stuNum) values(?)";
//			st = con.prepareStatement(InsertChosenMemSql);
//			st.setInt(1,duplicate.getStuNum());
//			st.executeUpdate();
//			
//			String UpdateChosenMemSql = "UPDATE temp_applicant AS t\n"
//					+ "INNER JOIN applicant AS a ON t.stuNum = a.stuNum\n"
//					+ "SET t.stuName = a.stuName,\n"
//					+ "    t.stuBirth = a.stuBirth,\n"
//					+ "    t.stuDept = a.stuDept,\n"
//					+ "    t.stuPhoneNum = a.stuPhoneNum,\n"
//					+ "    t.stuAddress = a.stuAddress,\n"
//					+ "    t.stuDetailAddress = a.stuDetailAddress,\n"
//					+ "    t.appliType = a.appliType,\n"
//					+ "    t.stuMail = a.stuMail,\n"
//					+ "    t.auditScore = a.auditScore,\n"
//					+ "    t.stuGrade = a.stuGrade,\n"
//					+ "    t.stuGender = a.stuGender;\n";
//			st = con.prepareStatement(UpdateChosenMemSql);
//			st.executeUpdate();			
//		}
//		
//		String ReturnMemSql = "select * from temp_applicant";
//		st = con.prepareStatement(ReturnMemSql);
//		ResultSet rs = st.executeQuery();
//		List<Applicant> applicantList = new ArrayList<>();
//		while(rs.next()) {
//			stuNum = rs.getInt("stuNum");
...
//			
//			
//			System.out.println(applicant.getStuNum() + " "+ applicant.getStuAddress()+ " "+applicant.getAuditScore()+ " "+applicant.getStuGrade());			
//		}
//		String DeleteTempSql = "Drop table temp_applicant";
//		st = con.prepareStatement(DeleteTempSql);
//		st.executeUpdate();
//		st.close();
//		
//		return applicantList;
